...
public class FoodSafetyOfficerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(Send, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 540, 370, 40));

        jLabel2.setFont(new java.awt.Font("PT Serif Caption", 1, 25)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel2.setText("Name:");
        add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 340, 160, 30));

        Name.setEditable(false);
        Name.setFont(new java.awt.Font("SansSerif", 0, 11)); // NOI18N
        add(Name, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 340, 190, 30));
        ...
        add(View, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 230, 360, 45));
        ...
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 40, 1209, 39));

        jLabel3.setFont(new java.awt.Font("PT Serif Caption", 1, 25)); // NOI18N
        jLabel3.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabel3.setText("Message:");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 430, 160, -1));

        Reply.setColumns(20);
        Reply.setRows(5);
        jScrollPane2.setViewportView(Reply);

        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 400, -1, -1));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/foodsafety.png"))); // NOI18N
        add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(-370, 0, 1790, 720));
