 ...
 */
package UserInterface.EventManager;
...
public class EventManagerWorkAreaJPanel extends javax.swing.JPanel {
    ...
    public EventManagerWorkAreaJPanel(JPanel userProcessContainer, Enterprise enterprise, Organisation organisation, UserAccount account, EcoSystem system, Network network) {
        initComponents();
     ...
     */
    public EventManagerWorkAreaJPanel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Participate in Food Drives");
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(353, 47, -1, -1));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(129, 121, 533, 168));
        ...
        add(Accept, new org.netbeans.lib.awtextra.AbsoluteConstraints(108, 380, -1, -1));

        jLabel3.setText("Message");
        add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 385, -1, -1));

        Msg.setColumns(20);
        Msg.setRows(5);
        jScrollPane2.setViewportView(Msg);

        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(434, 380, -1, -1));
    ...
    private void AcceptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AcceptActionPerformed
        ...
        if(selectedRow >=0){
            EventManagerWorkRequest request = (EventManagerWorkRequest) requestList.getValueAt(selectedRow, 2);
            if(!"Result Posted".equals(request.getStatus())){
                request.setStatus("Result Posted");
                request.setEventResult(Msg.getText());
