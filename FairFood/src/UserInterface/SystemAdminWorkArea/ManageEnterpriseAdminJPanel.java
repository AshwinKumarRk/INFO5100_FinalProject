...
private boolean cityPatternCorrect(String val3){
    ...
    private void initComponents() {
        ...
        backJButton1.setFont(new java.awt.Font("PT Serif Caption", 1, 18)); // NOI18N
        ...
        submitJButton1.setFont(new java.awt.Font("PT Serif Caption", 1, 18)); // NOI18N
        ...
        add(submitJButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 470, 98, 42));

        emailLbl.setFont(new java.awt.Font("PT Serif Caption", 1, 12)); // NOI18N
        emailLbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        emailLbl.setText("'aa@aa.com'");
        add(emailLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 290, 190, 20));

        passwordLbl.setFont(new java.awt.Font("PT Serif Caption", 1, 12)); // NOI18N
